...
set container name unifi environment TZ value 'Australia/Brisbane'
...
set container name onepassword-connect environment TZ value 'Australia/Brisbane'
...
set container name onepassword-sync environment TZ value 'Australia/Brisbane'
